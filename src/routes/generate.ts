...
generateRouter.post(
  ...
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      const settledPriceUsd = calculateUsagePriceUsd(selectedModel, serializedResponse);
      res.locals.finalChargeUsd = settledPriceUsd;
      res.setHeader("X-Prepaid-Charged-Usd", formatUsdPrice(settledPriceUsd));
